...
@WebServlet(name = "DeleteUserServlet", displayName = "DeleteUser", urlPatterns = "/delete_user.do")
        ...
        if (user != null) {
            if (user.getType() == User.STAFF) {
                ...
                if (userId != null) {
                    ...
                    dao.updateStaffInfo(userId, null, inputUser.getJobTitle(), inputUser.getGender(), inputUser.getTelNumber());
