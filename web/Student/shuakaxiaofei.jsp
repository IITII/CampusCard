...
<ul class="horizontal gray">
    ...
    <li><a href="/campus_card_war_exploded/Student/shuakaxiaofei.jsp" class="active">刷卡管理</a></li>
...
<ul class="vertical">
    <li><a href="/campus_card_war_exploded/Student/shuakaxiaofei.jsp" class="active">刷卡消费</a></li>
</ul>
<div class="leftPanel">
