...
<ul class="vertical">
    <li><a href="/campus_card_war_exploded/Teacher/shuakaxiaofei.jsp" class="active">人员信息增删改查</a></li>
    <li><a href="/campus_card_war_exploded/Teacher/shezhishangxian.jsp">人员排班</a></li>
</ul>
<div class="leftPanel">
