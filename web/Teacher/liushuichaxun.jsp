...
<ul class="horizontal gray">
    ...
    <li><a href="/campus_card_war_exploded/Teacher/chaxunlishiliushui.jsp" class="active">统计报表</a></li>
    <li class="rightLi" style="float: right"><a href="">注销</a></li>
</ul>
<ul class="vertical">
    <li><a href="/campus_card_war_exploded/Teacher/liushuichaxun.jsp" class="active">流水查询</a></li>
    <li><a href="/campus_card_war_exploded/Teacher/baobiaoshengcheng.jsp">报表生成</a></li>
</ul>
<div class="leftPanel">
