...
<ul class="vertical">
    <li><a href="/campus_card_war_exploded/Teacher/shuakaxiaofei.jsp">刷卡消费</a></li>
    <li><a href="/campus_card_war_exploded/Teacher/shezhishangxian.jsp" class="active">设置用户消费上限</a></li>
