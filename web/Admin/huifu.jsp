...
<ul class="vertical">
    ...
    <li><a href="${pageContext.request.contextPath}/Admin/huifu.jsp" class="active">恢复</a></li>
...
<div class="leftPanel">
    ...
    <form action="${pageContext.request.contextPath}/enable_card.do" method="post" class="form">
        <input name="redirect" value="Admin/huifu.jsp" hidden>
        <label>卡号：</label>
        <select name="card_id">
